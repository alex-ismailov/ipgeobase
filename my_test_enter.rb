...
keys = %w[query status continent continentCode region regionName city district zip lat
          lon timezone offset currency isp org as asname mobile proxy hosting]
